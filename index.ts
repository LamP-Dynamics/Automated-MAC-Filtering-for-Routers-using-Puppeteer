...
const PRIVILEGED = process.env.PRIVILEGED?.split('-') || '';

const sendLog = (message:string | unknown) => {
  console.log('=========================')
  console.log(message)
}

const puppet = async (page: Page, callback: () => Promise<void>, message:string):Promise<void> => {
  console.log(message)
